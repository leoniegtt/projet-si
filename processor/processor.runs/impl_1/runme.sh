...
HD_PWD='/home/goutte/4A/Projet_SI/projet-si/processor/processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chemin_donnees.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chemin_donnees.tcl -notrace
